...
import {sendVerificationCodeUsingPost} from "@/services/gigotapi-backend/userController";
      ...
      >
        ...
        <ProFormCaptcha
          ...
          onGetCaptcha={async (email) => {
            const res = await sendVerificationCodeUsingPost({email})
